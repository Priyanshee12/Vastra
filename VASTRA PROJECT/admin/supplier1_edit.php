...
?>
		...
		<form action="supplier1_update.php" method="post">
		...
		<tr>
			<td>bank name</td>
			<td><input type="text" requried value="<?php echo $rec['bank_name'];?>"
			name="bank_name"/></td>
		</tr>
		<tr>
			<td>ifsc code</td>
			<td><input type="text" requried value="<?php echo $rec['ifsc_code'];?>"
			name="ifsc_code"/></td>
		</tr>
		<tr>
			<td>branch name</td>
