...
//		$item->Visible = TRUE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[1] = $this->city_name->CurrentValue;
		} else {
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_view3" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="city_name"><div class="view3_city_name"><span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="city_name">
<?php if ($Page->SortUrl($Page->city_name) == "") { ?>
		<div class="ewTableHeaderBtn view3_city_name">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view3_city_name" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->city_name) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span>
