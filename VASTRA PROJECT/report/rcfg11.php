...
define("EWR_PROJECT_ID", "{2D3754CB-1385-48F7-961D-2232156AF52E}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "vastra", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'yaM26YH3dt1ewlS6', TRUE); // Random key for encryption
