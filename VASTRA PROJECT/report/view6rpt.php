...
<?php include_once "view6rptinfo.php" ?>
<?php
...
$view6_rpt = NULL; // Initialize page object first

class crview6_rpt extends crview6 {
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'view6', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fview6rpt";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_view6\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_view6',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fview6rpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fview6rpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fview6rpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['user_lname'] = ewr_Conv($rs->fields('user_lname'), 200);
				$this->FirstRowData['email_id'] = ewr_Conv($rs->fields('email_id'), 200);
				$this->FirstRowData['contact_number'] = ewr_Conv($rs->fields('contact_number'), 20);
				...
				$this->FirstRowData['city_id1'] = ewr_Conv($rs->fields('city_id1'), 3);
		} else { // Get next row
			$rs->MoveNext();
		}
		if (!$rs->EOF) {
			$this->user_fname->setDbValue($rs->fields('user_fname'));
			$this->user_lname->setDbValue($rs->fields('user_lname'));
			$this->email_id->setDbValue($rs->fields('email_id'));
			$this->contact_number->setDbValue($rs->fields('contact_number'));
			...
			$this->Val[1] = $this->user_fname->CurrentValue;
			$this->Val[2] = $this->user_lname->CurrentValue;
			$this->Val[3] = $this->email_id->CurrentValue;
			$this->Val[4] = $this->contact_number->CurrentValue;
			$this->Val[5] = $this->address->CurrentValue;
			$this->Val[6] = $this->password->CurrentValue;
			$this->Val[7] = $this->pincode->CurrentValue;
			$this->Val[8] = $this->gender->CurrentValue;
			$this->Val[9] = $this->city_name->CurrentValue;
			$this->Val[10] = $this->city_id1->CurrentValue;
		} else {
			$this->user_fname->setDbValue("");
			$this->user_lname->setDbValue("");
			$this->email_id->setDbValue("");
			$this->contact_number->setDbValue("");
			$this->address->setDbValue("");
			$this->password->setDbValue("");
			$this->pincode->setDbValue("");
			$this->gender->setDbValue("");
			$this->city_name->setDbValue("");
			$this->city_id1->setDbValue("");
		}
	}
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			// user_lname
			$this->user_lname->ViewValue = $this->user_lname->CurrentValue;
			$this->user_lname->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// email_id
			$this->email_id->ViewValue = $this->email_id->CurrentValue;
			$this->email_id->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// contact_number
			$this->contact_number->ViewValue = $this->contact_number->CurrentValue;
			$this->contact_number->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
			...
			$this->city_id1->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// user_lname
			$CurrentValue = $this->user_lname->CurrentValue;
			$ViewValue = &$this->user_lname->ViewValue;
			$ViewAttrs = &$this->user_lname->ViewAttrs;
			$CellAttrs = &$this->user_lname->CellAttrs;
			$HrefValue = &$this->user_lname->HrefValue;
			$LinkAttrs = &$this->user_lname->LinkAttrs;
			$this->Cell_Rendered($this->user_lname, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
			...
			// contact_number
			$CurrentValue = $this->contact_number->CurrentValue;
			$ViewValue = &$this->contact_number->ViewValue;
			$ViewAttrs = &$this->contact_number->ViewAttrs;
			$CellAttrs = &$this->contact_number->CellAttrs;
			$HrefValue = &$this->contact_number->HrefValue;
			$LinkAttrs = &$this->contact_number->LinkAttrs;
			$this->Cell_Rendered($this->contact_number, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
			...
			// city_id1
			$CurrentValue = $this->city_id1->CurrentValue;
			$ViewValue = &$this->city_id1->ViewValue;
			$ViewAttrs = &$this->city_id1->ViewAttrs;
			$CellAttrs = &$this->city_id1->CellAttrs;
			$HrefValue = &$this->city_id1->HrefValue;
			$LinkAttrs = &$this->city_id1->LinkAttrs;
			$this->Cell_Rendered($this->city_id1, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
		}
	...
	function SetupFieldCount() {
		...
		if ($this->user_lname->Visible) $this->DtlColumnCount += 1;
		if ($this->email_id->Visible) $this->DtlColumnCount += 1;
		if ($this->contact_number->Visible) $this->DtlColumnCount += 1;
		...
		if ($this->city_id1->Visible) $this->DtlColumnCount += 1;
	}
...
// Create page object
if (!isset($view6_rpt)) $view6_rpt = new crview6_rpt();
...
// Create page object
var view6_rpt = new ewr_Page("view6_rpt");

// Page properties
view6_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = view6_rpt.PageID;
</script>
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_view6" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_fname"><div class="view6_user_fname"><span class="ewTableHeaderCaption"><?php echo $Page->user_fname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_fname">
<?php if ($Page->SortUrl($Page->user_fname) == "") { ?>
		<div class="ewTableHeaderBtn view6_user_fname">
			<span class="ewTableHeaderCaption"><?php echo $Page->user_fname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_user_fname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->user_fname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->user_fname->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->user_lname->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_lname"><div class="view6_user_lname"><span class="ewTableHeaderCaption"><?php echo $Page->user_lname->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_lname">
<?php if ($Page->SortUrl($Page->user_lname) == "") { ?>
		<div class="ewTableHeaderBtn view6_user_lname">
			<span class="ewTableHeaderCaption"><?php echo $Page->user_lname->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_user_lname" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->user_lname) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->user_lname->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->user_lname->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->user_lname->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="email_id"><div class="view6_email_id"><span class="ewTableHeaderCaption"><?php echo $Page->email_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="email_id">
<?php if ($Page->SortUrl($Page->email_id) == "") { ?>
		<div class="ewTableHeaderBtn view6_email_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->email_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_email_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->email_id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->email_id->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->email_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->email_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
<?php } ?>
<?php if ($Page->contact_number->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="contact_number"><div class="view6_contact_number"><span class="ewTableHeaderCaption"><?php echo $Page->contact_number->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="contact_number">
<?php if ($Page->SortUrl($Page->contact_number) == "") { ?>
		<div class="ewTableHeaderBtn view6_contact_number">
			<span class="ewTableHeaderCaption"><?php echo $Page->contact_number->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_contact_number" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->contact_number) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->contact_number->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->contact_number->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->contact_number->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="address"><div class="view6_address"><span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="address">
<?php if ($Page->SortUrl($Page->address) == "") { ?>
		<div class="ewTableHeaderBtn view6_address">
			<span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_address" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->address) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->address->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="password"><div class="view6_password"><span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="password">
<?php if ($Page->SortUrl($Page->password) == "") { ?>
		<div class="ewTableHeaderBtn view6_password">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_password" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->password) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="pincode"><div class="view6_pincode"><span class="ewTableHeaderCaption"><?php echo $Page->pincode->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="pincode">
<?php if ($Page->SortUrl($Page->pincode) == "") { ?>
		<div class="ewTableHeaderBtn view6_pincode">
			<span class="ewTableHeaderCaption"><?php echo $Page->pincode->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_pincode" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->pincode) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->pincode->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="gender"><div class="view6_gender"><span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="gender">
<?php if ($Page->SortUrl($Page->gender) == "") { ?>
		<div class="ewTableHeaderBtn view6_gender">
			<span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_gender" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->gender) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->gender->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="city_name"><div class="view6_city_name"><span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="city_name">
<?php if ($Page->SortUrl($Page->city_name) == "") { ?>
		<div class="ewTableHeaderBtn view6_city_name">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_city_name" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->city_name) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_name->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->city_id1->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="city_id1"><div class="view6_city_id1"><span class="ewTableHeaderCaption"><?php echo $Page->city_id1->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="city_id1">
<?php if ($Page->SortUrl($Page->city_id1) == "") { ?>
		<div class="ewTableHeaderBtn view6_city_id1">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_id1->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer view6_city_id1" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->city_id1) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->city_id1->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->city_id1->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->city_id1->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->user_lname->Visible) { ?>
		<td data-field="user_lname"<?php echo $Page->user_lname->CellAttributes() ?>>
<span<?php echo $Page->user_lname->ViewAttributes() ?>><?php echo $Page->user_lname->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->email_id->Visible) { ?>
		<td data-field="email_id"<?php echo $Page->email_id->CellAttributes() ?>>
<span<?php echo $Page->email_id->ViewAttributes() ?>><?php echo $Page->email_id->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->contact_number->Visible) { ?>
		<td data-field="contact_number"<?php echo $Page->contact_number->CellAttributes() ?>>
<span<?php echo $Page->contact_number->ViewAttributes() ?>><?php echo $Page->contact_number->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->address->Visible) { ?>
...
<span<?php echo $Page->pincode->ViewAttributes() ?>><?php echo $Page->pincode->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->gender->Visible) { ?>
...
<span<?php echo $Page->city_name->ViewAttributes() ?>><?php echo $Page->city_name->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->city_id1->Visible) { ?>
		<td data-field="city_id1"<?php echo $Page->city_id1->CellAttributes() ?>>
<span<?php echo $Page->city_id1->ViewAttributes() ?>><?php echo $Page->city_id1->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
