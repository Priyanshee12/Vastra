...
class crview4 extends crTableBase {
	...
	function __construct() {
		...
		// product_id
		$this->product_id = new crField('view4', 'view4', 'x_product_id', 'product_id', '`product_id`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->product_id->Sortable = TRUE; // Allow sort
		$this->product_id->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->product_id->DateFilter = "";
		$this->product_id->SqlSelect = "";
		$this->product_id->SqlOrderBy = "";
