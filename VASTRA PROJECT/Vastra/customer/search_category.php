...
<?php
	...
	$sql="select p.id, p.product_name,p.product_price,p.description,p.product_size,p.quantity,p.image,c.category_name from product p, category c where c.category_id=p.category_id and c.category_name like '%$_POST[name]%'";
